           ...
           >
               ...
               <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                   <label style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                       <span style={{ fontWeight: 600, color: 'var(--on-surface-muted)' }}>Topic Title</span>
                       <input type="text" className="input-field" style={{ fontSize: '1.25rem' }} autoFocus placeholder="e.g. Newton's Laws" value={title} onChange={e => setTitle(e.target.value)} required />
                   </label>
